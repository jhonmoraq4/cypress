...
pipeline {
    ...
    post {
        always {
            ...
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'D:\\Repositorio\\Cypress\\reports', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
            deleteDir()
        }
    }
}